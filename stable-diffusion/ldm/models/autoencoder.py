...
from ldm.models.model_util import normalization
...
class Decoder(nn.Module):
    def __init__(self, *, ch, out_ch, ch_mult=(1,2,4,8), num_res_blocks,
        ...
        # attn_resolutions: []
        self.ch = ch                                        # 128
        self.num_resolutions = len(ch_mult)                 # [1, 2, 4, 4]
        self.num_res_blocks = num_res_blocks                # 2
        self.resolution = resolution                        # 256
        self.in_channels = in_channels                      # 3

        # compute in_ch_mult, block_in and curr_res at lowest res
        block_in = ch * ch_mult[self.num_resolutions - 1]               # 512
        curr_res = resolution // 2 ** (self.num_resolutions - 1)        # 32
    ...
    def forward(self, z):                   # z: [bs, 4, 64, 64]
        # z to block_in
        h = self.conv_in(z)                 # channel, 4 -> 512
